      ...
      <div className={`row ${styles.wrapper}`}>
        <div className={styles.maxWidth}>
          ...
          <p className={styles.description}>
            <FormattedMessage id={'AboveFooter.description'} defaultMessage={'Projektet med hästar är inte så jättekul att hålla på med när man är stressad och hellre gör annat'} />
          </p>
          <DownloadBar />
        </div>
      </div>
